...
This is a resume based on [Start Bootstrap](http://startbootstrap.com/) [Resume](https://startbootstrap.com/template-overviews/resume/). Bellow are the instructions on how you can access the basic template and create your own resume.
